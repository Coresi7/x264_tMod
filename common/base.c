...
REALIGN_STACK static int x264_generic_device_check( x264_param_t *param, const char *device, int device_mask )
{
...
REALIGN_STACK static int x264_param_restrict_device( x264_param_t *param, int i_profile, const char *device )
{
